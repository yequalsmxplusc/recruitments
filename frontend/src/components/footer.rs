...
pub fn footer() -> Html {
    ...
    html! {
        <footer class="w-full theme-footer px-6 py-8">
            <div class="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center space-y-6 sm:space-y-0 sm:space-x-8 text-center sm:text-left">
                ...
                <ul class="flex space-x-4">
                        ...
                        <li>
                            <a href="https://twitter.com/ju_ecell" class="opacity-70 hover:opacity-100 transition-opacity" title="Twitter">
                                <svg class="bi" width="22" height="22" fill="currentColor" viewBox="0 0 24 24">
