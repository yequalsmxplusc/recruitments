...
pub fn footer() -> Html {
    html! {
        <div class="max-w-7xl mx-auto px-4">
            <footer class="w-full border-t border-gray-200 dark:border-gray-700 mt-12 px-6 py-8">
    <div class="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center space-y-6 sm:space-y-0 sm:space-x-8 text-center sm:text-left">
                    <p class="text-gray-700">{"© 2025 " }<a href="https://www.juecell.com/">{"Jadavpur University Entrepreneurship Cell"}</a>{". All rights reserved."}</p>
